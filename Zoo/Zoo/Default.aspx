<%@ Page Title="Home Page" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.vb" Inherits="Zoo._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

    <div class="jumbotron">
        <h1 style="font-family: 'Berlin Sans FB'; font-size: 61px; color: #008000">Zoologico Ciudad Real<asp:Image ID="Image1" runat="server" Height="176px" ImageUrl="~/image/Koala.jpg" Width="248px" />
        </h1>
        <p>&nbsp;</p>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <H1 style="font-family: 'Berlin Sans FB'; color: #008000; font-size: xx-large; background-color: #C2AF96; text-decoration: underline overline;">Horarios</H1>
...
<TD style="color: green; font-size: 12pt">De 9:00 am a 2:00 pm</TD>
          ...
          <H1 style="font-family: 'Berlin Sans FB'; font-size: xx-large; color: #008000; background-color: #C2AF96; text-decoration: underline overline">Tarifas</H1>
...
<BR>
          <BR>
          <BR>
<p style="color: green; font-size: xx-large; font-family: 'Berlin Sans FB'; background-color: #C2AF96; text-decoration: underline overline;"> Tarifas para Instituciones Educativas: </p>           
<TABLE Border="1" width="100%">
<TR>
