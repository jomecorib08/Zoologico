<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Aves.aspx.cs" Inherits="zoologico.Aves" %>
...
&nbsp;&nbsp;
        ...
        <br />
        <br />
        <asp:ImageButton ID="ImageButton6" runat="server" Height="149px" ImageUrl="~/img/avestruz.jpg" Width="186px" />
&nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton7" runat="server" Height="149px" Width="186px" />
&nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton8" runat="server" Height="149px" Width="186px" />
&nbsp;
        <asp:ImageButton ID="ImageButton9" runat="server" Height="149px" Width="186px" />
    </form>
    </body>
</html>
