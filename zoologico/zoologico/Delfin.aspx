<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Delfin.aspx.cs" Inherits="zoologico.Delfin" %>
...
<body>
    ...
    <div style="font-family: 'Berlin Sans FB'; font-size: 57px; color: #008000; height: 59px; clip: rect(auto, 10px, auto, 10px);">
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" Height="229px" ImageAlign="TextTop" ImageUrl="~/img/Delfin.jpg" style="margin-top: 17px" Width="282px" />
        <br />
        <br />
        <br />
        <br />
...
<TR>
<TH colspan ="2" style="color: green; font-size: 12pt">Delfin</TH>
