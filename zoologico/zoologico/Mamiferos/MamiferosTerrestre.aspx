...
&nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton3" runat="server" Height="145px" ImageUrl="~/img/Koala.jpg" Width="189px" PostBackUrl="~/Koala.aspx" />
&nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton4" runat="server" Height="145px" ImageUrl="~/img/Leon.jpg" Width="189px" PostBackUrl="~/Leon.aspx" />
        <br />
        <br />
        <br />
        <br />
        <br />
        <asp:ImageButton ID="ImageButton5" runat="server" Height="145px" ImageUrl="~/img/oso.jpg" Width="189px" PostBackUrl="~/Oso.aspx" />
&nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton6" runat="server" Height="145px" ImageUrl="~/img/rino.jpg" Width="189px" PostBackUrl="~/Rino.aspx" />
&nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton7" runat="server" Height="145px" ImageUrl="~/img/oso.jpg" Width="189px" />
&nbsp;&nbsp;
        <asp:ImageButton ID="ImageButton8" runat="server" Height="145px" ImageUrl="~/img/Delfin.jpg" Width="189px" PostBackUrl="~/Delfin.aspx" />
    </form>
</body>
</html>
