<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="oso.aspx.cs" Inherits="zoologico.oso" %>
...
<body>
    ...
    <div style="font-family: 'Berlin Sans FB'; font-size: 57px; color: #008000; height: 59px; clip: rect(auto, 10px, auto, 10px);">
       ...
       Oso <br />
        ...
        <asp:ImageButton ID="ImageButton1" runat="server" Height="229px" ImageAlign="TextTop" ImageUrl="~/img/oso.jpg" style="margin-top: 17px" Width="282px" />
        <br />
        <br />
        <br />
        <br />
...
<TR>
<TH colspan ="2" style="color: green; font-size: 12pt">Oso</TH>
