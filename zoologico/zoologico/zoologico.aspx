    ...
    <div class="row">
        <div class="col-md-4" >
            ...
            <p style="font-family: 'Berlin Sans FB'; font-size: x-large; color: #008000; background-color: #C1C1A2;">
                Acuaticos</p>
            <p>
                <asp:ImageButton ID="ImageButton1" runat="server" Height="129px" ImageUrl="~/img/Delfin.jpg" Width="181px" OnClick="ImageButton1_Click" PostBackUrl="~/Acuaticos/Acuaticos.aspx" />
            </p>
            <p style="font-family: 'Berlin Sans FB'; font-size: x-large; color: #008000; background-color: #C1C1A2;">
                Mamiferos</p>
            <p>
                <asp:ImageButton ID="ImageButton2" runat="server" Height="145px" ImageUrl="~/img/Leon.jpg" Width="185px" PostBackUrl="~/Mamiferos/MamiferosTerrestre.aspx" />
            </p>
            <p style="font-family: 'Berlin Sans FB'; color: #008000; font-size: x-large; background-color: #C1C1A2;">
                Aves</p>
            <p>
                <asp:ImageButton ID="ImageButton3" runat="server" Height="126px" ImageUrl="~/img/Aguila.jpg" Width="184px" PostBackUrl="~/Aves/Aves.aspx" />
            </p>
            <p>
                &nbsp;</p>
            <p>
    ...
    <a class="btn btn-default" href="Horarios_Tarifas.aspx" style="color: #000000; background-color: #008000">Horarios y tarifas &raquo;</a>
        ...
        <div class="col-md-4">
            ...
            <p>
                ...
                sitio</p>
            <p>
                <asp:ImageButton ID="ImageButton4" runat="server" Height="218px" ImageUrl="~/img/mapa.png" Width="286px" />
            </p>
